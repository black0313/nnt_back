...
import com.example.nnt_project.utils.Constants;
        ...
        if ("always".equals(initMode)) {
            ...
            if (userRepository.findByUsername("superadmin").isEmpty()) {
                User admin = User.builder()
                        .firstname("KattaAdminbek")
                        .lastname("KattaAdminbekov")
                        .username("superadmin")
                        .password(passwordEncoder.encode("123"))
                        .role(roleRepository.save(new Role(Constants.SUPER_ADMIN, Arrays.stream(Permissions.values()).toList())))
                        .build();
            ...
            if (userRepository.findByUsername("admin").isEmpty()) {
                User admin = User.builder()
                        ...
                        .username("admin")
                        .password(passwordEncoder.encode("123"))
                        .role(roleRepository.save(new Role(Constants.ADMIN, Arrays.stream(Permissions.values()).toList())))
                        .build();
                userRepository.save(admin);
            }
            ...
            if (userRepository.findByUsername("manager").isEmpty()) {
                User manager = User.builder()
                        ...
                        .username("manager")
                        .password(passwordEncoder.encode("123"))
                        .role(roleRepository.save(new Role(Constants.MANAGER, Arrays.stream(Permissions.values()).toList())))
                        .build();
            ...
            if (userRepository.findByUsername("dispatcher").isEmpty()) {
                User dispatcher = User.builder()
                        ...
                        .username("dispatcher")
                        .password(passwordEncoder.encode("123"))
                        .role(roleRepository.save(new Role(Constants.EMPLOYEE, Arrays.stream(Permissions.values()).toList())))
                        .build();
